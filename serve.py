...
e fornece endpoints para processamento de novos templates JSON.
"""
    ...
    <body>
        ...
        <section class="header-section">
            <div class="container">
                ...
                <p class="text-center lead">Adicione novas conversas ao sistema Jesus Chat Memórias</p>
            </div>
        </section>
        ...
        <div class="container">
            <div class="upload-container">
                ...
                <div class="mt-5">
                    ...
                    <div class="mb-3">
                        <textarea class="form-control" id="jsonText" rows="10" placeholder="Cole o conteúdo JSON aqui..."></textarea>
                    </div>
